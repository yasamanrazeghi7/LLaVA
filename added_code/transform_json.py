    ...
    with open(input_file_path, 'r') as infile, open(output_file_path, 'w') as outfile:
        ...
        for line in infile:
            ...
            if 'figure_id' in json_obj:
                json_obj['image'] = json_obj.pop('figure_id')
            
            # Write the modified JSON object back to the new file
            outfile.write(json.dumps(json_obj) + '\n')

# Call the function with the paths of your input and output files
modify_jsonl('/Users/yasaman/Documents/PhD/visualQA/LLAVA/LLaVA/playground/data/eval/visualQA/questions_sources_1.jsonl', '/Users/yasaman/Documents/PhD/visualQA/LLAVA/LLaVA/playground/data/eval/visualQA/transformed_questions_sources_1.jsonl')
